...
class BackgroundTypo extends Component {
  constructor(props) {
    super(props);
    this.backgroundTypoRef = createRef();
    this.handler = null;
  }

  componentDidMount() {
    this.handler = () => {
      this.backgroundTypoRef.current.style.top = `-${window.scrollY * 1.5}px`;
    };
  ...
  render() {
    return (
      <section id="backgroundTypo" ref={this.backgroundTypoRef}>
        {TYPO_TEXT}
      </section>
    );
  }
