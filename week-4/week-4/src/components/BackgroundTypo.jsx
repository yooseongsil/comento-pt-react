...
export class BackgroundTypo extends React.Component {
  constructor(props) {
    super(props);
    this.handler = null;
  ...
  componentDidMount() {
    this.handler = () => {
      if (this.typoRef.current) {
        this.typoRef.current.style.top = `-${window.scrollY * 1.5}px`;
      }
    };
  ...
  render() {
    return <section ref={this.typoRef} id="backgroundTypo">
