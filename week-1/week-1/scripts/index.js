...
const isKoreanLanguage = getLanguage() === 'ko';

const getLocale = (property) => {
  return LOCALE[getLanguage()][property];
}
...
const createProductCard = ({ id, nameI18n, name, description, image }) => `
  <div id=${`product${id}`} class="product-card">
    ...
    <div class="product-card-text">
      <div>${getLocale('productName')} <br />${isKoreanLanguage ? nameI18n : name}</div>
      <div class="product-card-description">${getLocale('description')} <br/> ${description}</div>
    </div>
  </div>
`;
